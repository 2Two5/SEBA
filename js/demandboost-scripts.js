...
// Header search with Google
	...
	if(searchForm){
		...
		searchForm.on('submit', function(e){
			var qs = 'site:'+DBConfig.searchDomain +' '+searchInput.val();
			$(this).find('#q').val(qs);
			return true;
		});
	}
	...
	if (searchForms) {
		searchForms.on('submit', function(e) {
			var searchInput = $(this).find('.elm-searchbox__input'),
				...
				qs = 'site:' + DBConfig.searchDomain + ' ' + __search;
			searchInput.val(qs);
...
// Sticky Header
	if(DBConfig.enableStickyHeader ){
